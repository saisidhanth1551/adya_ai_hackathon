    ...
    switch (selected_server) {
        ...
        case "WOOCOMMERCE":
            args["__credentials__"] = {
                ...
                "consumerKey": server_credentials[selected_server]?.consumerKey || "",
                "consumerSecret": server_credentials[selected_server]?.consumerSecret || "",
                "version": server_credentials[selected_server]?.version || "wc/v3",
            }
            break;
        case "TODOIST":
            args["__credentials__"] = {
                "TODOIST_API_TOKEN": server_credentials[selected_server]?.TODOIST_API_TOKEN || "",
            }
            break;
        default:
            break;
